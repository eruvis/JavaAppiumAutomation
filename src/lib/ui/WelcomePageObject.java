...
public class WelcomePageObject extends MainPageObject {
    ...
    public void waitForNewWayToExploreText() {
        this.waitForElementPresent(By.id(STEP_NEW_WAY_TO_EXPLORE_TEXT), "Cannot find " + STEP_NEW_WAY_TO_EXPLORE_TEXT + " text", 10);
    }

    public void waitForAddOrEditPreferredLangText() {
        this.waitForElementPresent(By.id(STEP_ADD_OR_EDIT_PREFERRED_LANG_LINK), "Cannot find " + STEP_ADD_OR_EDIT_PREFERRED_LANG_LINK + " link", 10);
    }
